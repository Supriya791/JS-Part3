...
/*
const myString = '{"firstName":"suppi",  "lastName":"riya"}';
...
var obj1 = new Account(12345,"suppi",65546);
console.log(obj1);
...
var objSavings = new Savings("true",98765,"riya",546776); //creating Savings object
console.log(objSavings);
console.log(objSavings.withdraw(500));
console.log(objSavings.getCurrentBalance());

var objCurrent = new Current(550,9876543,"Neha",5467878); //creating Current object
